...
def main():
    print("--- StrataKV-Torch Baseline Runner for GLM 5 ---")
    ...
    try:
        ...
        # Some GLM models use AutoModel instead of AutoModelForCausalLM
        try:
    ...
    print("Baseline test complete. Tier 0 and Tier 1 successfully hooked for GLM 5.")
